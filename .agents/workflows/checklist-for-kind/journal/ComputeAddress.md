...
| --- | --- | --- | --- | --- | --- |
| Step 1: Direct API Types | [#9730](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/9730) | [#9732](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9732) | Green/Pending Merge | 2026-06-12 | - |
